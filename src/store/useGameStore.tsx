...
const initialParty: Character[] = [
  ...
  { id: '4', name: 'ロンド', class_id: 'rogue', level: 1, xp: 0, stats: { str: 10, dex: 16, con: 12, int: 14, wis: 10, cha: 12 }, hp: { current: 9, max: 9 }, hit_dice_remaining: 1, spell_slots: {}, ac: 14, position: 'front', is_alive: true, status_effects: [], equipped_weapon_id: 'shortsword' },

...
export const itemList: Record<string, ItemData> = {
  ...
  shortbow_plus_1: {
    ...
    type: 'weapon',
    weapon_category: 'ranged',
    description: '呪文のような加護を受けた小型弓。攻撃ロールとダメージに +1 の修正がつく。',
    value_gp: 700,
    attack_bonus: 1,
    damage_bonus: 1,
    damage_dice: '1d6',
  ...
  shortbow_plus_2: {
    ...
    type: 'weapon',
    weapon_category: 'ranged',
    description: 'より強力な加護を受けた小型弓。攻撃ロールとダメージに +2 の修正がつく。',
    value_gp: 2400,
    attack_bonus: 2,
    damage_bonus: 2,
    damage_dice: '1d6',
  ...
  longbow_plus_1: {
    ...
    type: 'weapon',
    weapon_category: 'ranged',
    description: '呪文のような加護を受けた大型長弓。攻撃ロールとダメージに +1 の修正がつく。',
    value_gp: 900,
    attack_bonus: 1,
    damage_bonus: 1,
    damage_dice: '1d8',
  ...
  longbow_plus_2: {
    ...
    type: 'weapon',
    weapon_category: 'ranged',
    description: 'より強力な加護を受けた大型長弓。攻撃ロールとダメージに +2 の修正がつく。',
    value_gp: 3000,
    attack_bonus: 2,
    damage_bonus: 2,
    damage_dice: '1d8',
